...
src/lib/
  ...
  importSession.ts parseImportedSession(raw, library) — import IA tolérant : strict (coach) sinon JSON « lâche » normalisé (clés variables, reps « 8-12 »/« 30s », extraction des ```json fences, enrichissement par la biblio)
