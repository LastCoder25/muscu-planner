 ...
 *  Les règles vivent dans `lib/runStats`, partagées avec les boss de palier. */
export {
  normalizeRunStats as normalizeLabyStats,
  runStarted as labyRunStarted,
  runCleared as labyRunCleared,
  runSuccessPct as labySuccessPct,
  type RunStats as LabyStats,
} from '@/lib/runStats';
