...
export const CHALLENGE_FORMATS: FormatOption[] = [
  {
    id: 'fixed',
    name: 'Fixe',
    desc: 'Même objectif chaque jour.',
    icon: 'drag_handle',
    fields: ['start'],
  },
  {
  ...
  },
  {
    id: 'wave',
    name: 'Vagues',
    desc: 'Cycles de montée avec un jour de décharge.',
    icon: 'waves',
    fields: ['start', 'increment', 'cycle_days', 'deload_pct'],
  },
  {
    id: 'cumulative',
    name: 'Objectif cumulé',
    desc: 'Un total à atteindre sur la durée, à ton rythme.',
    icon: 'functions',
    fields: ['total'],
  },
];
