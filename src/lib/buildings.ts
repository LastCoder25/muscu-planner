...
export const BUILDING_TYPES: BuildingType[] = [
  ...
  // → tu peux t'absenter plus longtemps sans saturer, ET il accélère les RÉPARATIONS
  // de l'enceinte.
  //
  // ⚠️ LA RÉPARATION VIENT DE LA FONDERIE, RETIRÉE (demandé). Elle avait DEUX métiers —
  // battre la ferraille, et raccourcir les travaux — et le second n'était PAS dans la
  // demande : le perdre en silence aurait doublé les temps de remise en état de tous les
  // comptes existants. Il atterrit ici parce que l'Entrepôt est le seul bâtiment civil
  // qui parle déjà de STOCK, et que la ferraille est justement ce qu'on y puise pour
  // réparer. Il y gagne un SECOND levier, lui qui n'en avait qu'un.
  {
    id: 'warehouse',
    perLevelNote: '+15 % de stockage sur TOUS tes producteurs, et des réparations plus rapides',
    label: 'Entrepôt',
    emoji: '🏬',
    category: 'utility',
    ...
    unlockLevel: 3,
    unique: true,
    desc: 'Augmente le stockage de tous tes producteurs (+15 %/niveau), et accélère les réparations de l’enceinte.',
  },
