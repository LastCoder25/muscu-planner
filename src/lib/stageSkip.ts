// stageSkip.ts — faut-il jouer l'animation d'un combat de donjon, de boss ou de portail ?
 ...
 *  - `setting` : le joueur a choisi de TOUJOURS passer (donjons, boss, portail), 1re visite comprise ;
