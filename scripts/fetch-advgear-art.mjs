...
const SUBJECTS = {
  ...
  // ── ARCHER ──
  'archer-weapon-b': 'simple wooden hunting bow lying horizontally on a wooden table',
  'archer-weapon-a': 'elegant carved yew longbow lying horizontally on a wooden table',
  'archer-weapon-s': 'ornate silver longbow with glowing crescent moon tips lying horizontally on a stone table',
  ...
  'archer-accessory-a': 'carved leather quiver with brass fittings and fletched arrows lying on a wooden table',
  ...
  // ── CARAVANIER ──
  'caravanier-weapon-b': 'plain wooden walking staff lying horizontally on a wooden table',
  'caravanier-weapon-a': 'iron-shod guide staff with a brass knob',
  'caravanier-weapon-s': 'carved wooden travel staff with glowing golden map lines lying horizontally on a table',
