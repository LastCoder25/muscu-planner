...
const MAP = {
  ...
  // Ajouts (audit couverture) : 8 exos de muscu qui n avaient aucune illustration,
  // dont le Souleve de terre — un compose majeur present dans les programmes et le 360.
  ex_deadlift: 'Barbell_Deadlift',
  ex_hammer_curl: 'Hammer_Curls',
  ex_chest_fly_dumbbell: 'Dumbbell_Flyes',
  ex_front_raise: 'Front_Dumbbell_Raise',
  ex_overhead_triceps: 'Standing_Dumbbell_Triceps_Extension',
