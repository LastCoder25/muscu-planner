...
export const SPLIT_CATALOG: Record<number, SplitOption[]> = {
  2: [
    fullBody(2),
    {
      id: 'upper_lower',
      name: 'Haut / Bas',
      subtitle: 'Haut du corps puis bas',
      days: [
        { name: 'Haut', muscles: UPPER },
        { name: 'Bas', muscles: LOWER },
      ],
    },
  ],
  3: [
    fullBody(3),
    {
      id: 'ppl',
      name: 'Push / Pull / Legs',
      subtitle: 'Poussée · Tirage · Jambes',
      days: [
        { name: 'Push (poussée)', muscles: PUSH },
        { name: 'Pull (tirage)', muscles: PULL },
        { name: 'Legs (jambes)', muscles: LEGS },
      ],
    },
    {
      id: 'pjd',
      name: 'Pecs+Bras / Jambes / Dos+Épaules',
      subtitle: 'Découpe par zones',
      days: [
  ...
  4: [
    {
      id: 'upper_lower_2',
      name: 'Haut / Bas (×2)',
      subtitle: 'Haut, Bas, Haut, Bas',
      days: [
        { name: 'Haut A', muscles: UPPER },
        { name: 'Bas A', muscles: LOWER },
        { name: 'Haut B', muscles: UPPER },
        { name: 'Bas B', muscles: LOWER },
      ],
    },
    {
      id: 'ppl_upper',
      name: 'Push / Pull / Legs / Haut',
      subtitle: 'PPL + un haut du corps',
      days: [
        { name: 'Push (poussée)', muscles: PUSH },
        { name: 'Pull (tirage)', muscles: PULL },
        { name: 'Legs (jambes)', muscles: LEGS },
    ...
    {
      id: 'split4',
      name: 'Pecs / Dos / Jambes / Épaules+Bras',
      subtitle: 'Découpe par zones',
      days: [
        { name: 'Pecs', muscles: ['pectoraux'] },
        { name: 'Dos', muscles: ['dos'] },
        { name: 'Jambes', muscles: LEGS },
        { name: 'Épaules + Bras', muscles: ['épaules', 'biceps', 'triceps'] },
      ],
    },
  ],
  5: [
    {
      id: 'ppl_ul',
      name: 'Push / Pull / Legs / Haut / Bas',
      subtitle: 'PPL + Haut/Bas',
      days: [
        { name: 'Push (poussée)', muscles: PUSH },
        { name: 'Pull (tirage)', muscles: PULL },
        { name: 'Legs (jambes)', muscles: LEGS },
    ...
    },
    {
      ...
      days: [
        ...
        { name: 'Dos', muscles: ['dos'] },
        { name: 'Jambes', muscles: LEGS },
        { name: 'Épaules', muscles: ['épaules', 'abdominaux'] },
